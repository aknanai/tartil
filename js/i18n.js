...
(function (BA) {
  ...
  const S = {
    ...
    'nav.drill':            { en: 'Drill', fr: 'Exercice', es: 'Ejercicio', ur: 'مشق', ar: 'تمرين' },
    ...
    // drill (English-only for now — fr/es/ur/ar are TODO for a native reviewer)
    'drill.setupTitle':   { en: '🏗️ Cumulative drill' },
    'drill.intro':        { en: 'Repeat each new ayah, then chain it back to the range start — the backbone of durable ḥifẓ. Set the range and pattern, then start.' },
    'drill.pattern':      { en: 'Pattern' },
    'drill.custom':       { en: 'Custom' },
    'drill.newReps':      { en: 'Repeat each new ayah' },
    'drill.newRepsHint':  { en: 'a number (5) or a per-ayah cycle (4,3,3)' },
    'drill.chainReps':    { en: 'Repeat each chain' },
    'drill.chainMode':    { en: 'Chain covers' },
    'drill.chainFull':    { en: 'From range start' },
    'drill.chainWindow':  { en: 'Rolling window' },
    'drill.windowSize':   { en: 'Window size' },
    'drill.chainEvery':   { en: 'Chain every N ayāt' },
    'drill.finalPass':    { en: 'Final whole-range passes' },
    'drill.singleLevel':  { en: 'Text while repeating an ayah' },
    'drill.chainLevel':   { en: 'Text during chains' },
    'drill.perAyahOnly':  { en: 'Drills need a per-ayah reciter (whole-surah recordings can’t isolate an ayah). Pick one below.' },
    'drill.start':        { en: '▶ Start drill' },
    'drill.editorTitle':  { en: 'Steps' },
    'drill.summary':      { en: '{steps} steps · {plays} total plays' },
    'drill.reset':        { en: 'Reset edits' },
    'drill.saveAs':       { en: '💾 Save as pattern…' },
    'drill.savePrompt':   { en: 'Name this pattern:' },
    'drill.saved':        { en: 'Pattern saved' },
    'drill.deletePattern':{ en: 'Delete this saved pattern?' },
    'drill.tooBig':       { en: 'That drill is too long — shorten the range or repeats.' },
    'drill.lblSingle':    { en: 'Ayah {n} ×{reps}' },
    'drill.lblChain':     { en: 'Chain {from}–{to} ×{reps}' },
    'drill.lblFinal':     { en: 'Full range {from}–{to} ×{reps}' },
    'drill.stepOf':       { en: 'Step {k} / {total}' },
    'drill.prevStep':     { en: '⏮ Prev step' },
    'drill.skipStep':     { en: '⏭ Skip step' },
    'drill.repeatStep':   { en: '🔁 Repeat step' },
    'drill.end':          { en: '■ End' },
    'drill.completeTitle':{ en: 'Drill complete' },
    'drill.gradeTitle':   { en: 'Grade the range for spaced review' },
    'drill.drillAgain':   { en: '↻ Drill again' },
    'drill.goReview':     { en: '🎯 Go to Review' },
    'drill.resumeTitle':  { en: 'Resume your drill?' },
